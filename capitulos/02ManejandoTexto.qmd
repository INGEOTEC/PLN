...
¿Cuántos segmentos genera `TextModel` al procesar la frase *buenos días, bienvenidos al curso de Procesamiento de Lenguaje Natural.* cuando se usa una combinación entre palabras, 4-gramas de palabras y bigramas de caracteres?
::::
::: 
...
¿Cuántos diferentes `input_ids` se utilizan al segmentar la oración *buenox días* utilizando `bilmaLAT`?
::::
:::
